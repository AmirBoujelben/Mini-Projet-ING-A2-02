...
export const SideNavbar = () => {
  ...
  if (user.Role == "Etudiant")
    return (
      <div className="h-screen min-w-60 bg-white shadow-[rgba(17,_17,_26,_0.1)_0px_0px_16px] overflow-hidden">
        <Link to={""}>
          <img
    ...
    return (
      <div className="h-screen min-w-[18rem] bg-white shadow-[rgba(17,_17,_26,_0.1)_0px_0px_16px] overflow-hidden">
        <Link to={""}>
          <img
            className="mt-[2rem] mx-auto h-[4rem] mb-[5rem] cursor-pointer"
            src={issatLogo}
    ...
    return (
      <div className="h-screen min-w-80 bg-white shadow-[rgba(17,_17,_26,_0.1)_0px_0px_16px] overflow-hidden">
        <Link to={""}>
          <img
            className="mt-[2rem] mx-auto h-[4rem] mb-[5rem] cursor-pointer"
            src={issatLogo}
    ...
    return (
      <div className="h-screen min-w-72 bg-white shadow-[rgba(17,_17,_26,_0.1)_0px_0px_16px] overflow-hidden">
        <Link to={""}>
          <img
            className="mt-[2rem] mx-auto h-[4rem] mb-[5rem] cursor-pointer"
            src={issatLogo}
